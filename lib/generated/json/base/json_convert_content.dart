...
class JsonConvert {
	static final Map<String, JsonConvertFunction> convertFuncMap = {
		...
		(UserSkills).toString(): UserSkills.fromJson,
		(UserReferences).toString(): UserReferences.fromJson,
	};
...
List<T>? convertListNotNull<T>(dynamic value, {EnumConvertFunction? enumConvert}) {
  ...
  T? _asT<T extends Object?>(dynamic value,
	...
	static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
		...
		if(<UserSkills>[] is M){
			return data.map<UserSkills>((Map<String, dynamic> e) => UserSkills.fromJson(e)).toList() as M;
		}
		if(<UserReferences>[] is M){
			return data.map<UserReferences>((Map<String, dynamic> e) => UserReferences.fromJson(e)).toList() as M;
		}
